...
export class PeterpanzListingAdapter extends BaseUserOnlyAdapter {
  ...
  normalizeFromRawRecord(rawRecord) {
    ...
    const item = {
      ...
      building_name: raw.location?.address?.aptName || null,
      room_count: raw.info?.room_count ?? null,
      bathroom_count: raw.bathroom_count ?? null,
      parking_possible: raw.additional_options?.have_parking_lot != null ? Boolean(raw.additional_options.have_parking_lot) : null,
      building_year: raw.building_year ?? null,
      description_text: raw.description_text || null,
      available_date: raw.available_date || null,
      jibun_address: raw.jibun_address || null,
